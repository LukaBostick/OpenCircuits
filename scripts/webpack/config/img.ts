        ...
        rules: [
            {
                ...
                type: "asset",
                /type: "asset/resource", //his extracts all images as separate files
                /type: "asset/inline", //his inlines all images

                /parser: {
                /    dataUrlCondition: {
                /        maxSize: 30 * 1024, //et inline-size to 30kb (30 * 1024 bytes)
                /    }
                /}
            },
        ],
